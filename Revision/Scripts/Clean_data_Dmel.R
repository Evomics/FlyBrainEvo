...
sc_Dmel1 <- load10X('cellranger/brain/Dmel.count/run_count_dmel_brain_1/outs/')
...
sc_Dmel2 <- load10X('cellranger/brain/Dmel.count/run_count_dmel_brain_2/outs/')
...
sc_Dmel3 <- load10X('cellranger/brain/Dmel.count/run_count_dmel_brain_3/outs/')
...
sc_Dmel4 <- load10X('cellranger/brain/Dmel.count/run_count_dmel_brain_4/outs/')
...
sc_Dmel5 <- load10X('cellranger/brain/Dmel.count/run_count_dmel_brain_5/outs/')
...
sc_Dmel6 <- load10X('cellranger/brain/Dmel.count/run_count_dmel_brain_6/outs/')
...
bcmvn_Dmel_decon_combined <- find.pK(sweep.stats_Dmel_decon_combined)  ## pk=0.14
...
Dmel_decon_combined <- doubletFinder_v3_SCT(Dmel_decon_combined, PCs = 1:50, pN = 0.25, pK = 0.14, nExp = nExp_poi.adj, reuse.pANN = F, sct = T)

DimPlot(Dmel_decon_combined,
        pt.size = 0.01, label=F, reduction = "umap",
        group.by = "DF.classifications_0.25_0.14_8019" )+theme(aspect.ratio = 1)
...
Dmel_decon_combined_DF <- subset(Dmel_decon_combined, subset = DF.classifications_0.25_0.14_8019 == "Singlet")
...
FeaturePlot(Dmel_decon_combined, feature='Pka-R2', order=T)
DimPlot(Dmel_decon_combined, label=T)

Dmel_celltype_KC_doublet <- subset(Dmel_decon_combined, idents = c(7,8,17,18))
...
Dmel_celltype_KC_DF <- subset(Dmel_celltype_KC_doublet, subset = DF.classifications_0.25_0.14_8019 == "Singlet")
...
Dmel_celltype_KC_DF <- FindClusters(Dmel_celltype_KC_DF, resolution = 0.2)
...
FeaturePlot(object=Dmel_celltype_KC_DF, feature="rn")
